...
"""
Unified cluster definitions for CitySearch AI.
Single source of truth for cluster names, descriptions, and explanations.

Usage:
    from core.cluster_definitions import get_cluster_info, explain_cluster, CLUSTER_COUNT
"""
